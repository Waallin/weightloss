...
const AnimatedInput: React.FC<AnimatedInputProps> = ({
  ...
  const containerStyle = useAnimatedStyle(() => {
    const borderColorValue = interpolate(isFocused.value, [0, 1], [0, 1]);

    return {
      borderColor:
        borderColorValue === 0 ? Colors.neutral[200] : Colors.primary[400],
      ...
      shadowOpacity: interpolate(isFocused.value, [0, 1], [0.05, 0.1]),
    };
  });

  const iconStyle = useAnimatedStyle(() => {
    return {
      opacity: interpolate(isFocused.value, [0, 1], [0.7, 1]),
      transform: [
        {
          scale: interpolate(
            isFocused.value,
  ...
  return (
    <Animated.View style={[buttonStyle, secondary ? {} : styles.buttonShadow]}>
      ...
      >
        {isLoading ? (
          <ActivityIndicator
            color={secondary ? Colors.primary[600] : "#FFFFFF"}
            size="small"
          />
        ) : (
  ...
  const renderPhoneInput = () => (
    <Animated.View style={[styles.formContent, formAnimatedStyle]}>
      ...
      <Text style={styles.privacyText}>
        We'll send a verification code to this number. Standard message rates
        may apply.
      </Text>
      ...
      <View style={styles.roleOptions}>
        <RoleOption
          icon={
            <ShieldCheck
              size={24}
              color={selectedRole === "owner" ? "#FFFFFF" : Colors.neutral[500]}
            />
          }
          title="Owner"
        ...
        <RoleOption
          icon={
            <Anchor
              size={24}
              color={
                selectedRole === "captain" ? "#FFFFFF" : Colors.neutral[500]
              }
            />
          }
          title="Captain"
        ...
        <RoleOption
          icon={
            <Users
              size={24}
              color={selectedRole === "crew" ? "#FFFFFF" : Colors.neutral[500]}
            />
          }
          title="Crew"
    ...
    <View style={styles.container}>
      ...
      <KeyboardAvoidingView
        ...
        keyboardVerticalOffset={
          Platform.OS === "ios" ? (insets.bottom > 0 ? 20 : 40) : 0
        }
      >
        <LinearGradient
          colors={[
        ...
        >
          <View style={styles.wavesOverlay}>
            <Waves
              ...
              size={width * 1.2}
              style={styles.waveLarge}
            />
            <Waves
              color="rgba(255,255,255,0.08)"
              size={width}
              style={styles.waveMedium}
            />
            <Waves
              color="rgba(255,255,255,0.12)"
              size={width * 0.8}
              style={styles.waveSmall}
            />
          </View>
              ...
              >
                <View style={styles.logoWrapper}>
                  <MaskedView
                    style={[
                      styles.maskView,
                      isSmallScreen && styles.maskViewSmall,
                    ]}
                    maskElement={
                  ...
                  <Text
                    style={[
                      styles.tagline,
                      isSmallScreen && styles.taglineSmall,
                    ]}
                  >
